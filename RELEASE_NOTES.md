RobCoOS 0.4.4 highlights since 0.4.3:
...
- set explicit macOS bundle icon metadata in the release workflow so the packaged `.app` advertises the shipped `RobCoOS.icns` resource cleanly
