...
use nucleon::native::{
    ...
    standalone_env_value, NucleonNativeInstallerApp,
};
...
fn main() -> Result<()> {
    ...
    let mut viewport = ViewportBuilder::default()
        ...
        .with_inner_size(NucleonNativeInstallerApp::default_window_size())
        .with_min_inner_size(NucleonNativeInstallerApp::min_window_size());
    ...
    eframe::run_native(
        ...
        Box::new(move |cc| {
            ...
            Ok(Box::new(NucleonNativeInstallerApp::new(
