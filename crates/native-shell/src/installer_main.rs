...
use robcos::native::{
    ...
    RobcoNativeInstallerApp, ROBCOS_NATIVE_STANDALONE_USER_ENV,
};

const APP_ICON_BYTES: &[u8] = include_bytes!("../../../icon.png");
const APP_TITLE: &str = "Program Installer";
...
fn main() -> Result<()> {
    ...
    let mut viewport = ViewportBuilder::default()
        ...
        .with_inner_size(RobcoNativeInstallerApp::default_window_size())
        .with_min_inner_size(RobcoNativeInstallerApp::min_window_size());
    ...
    eframe::run_native(
        ...
        Box::new(move |cc| {
            ...
            Ok(Box::new(RobcoNativeInstallerApp::new(
