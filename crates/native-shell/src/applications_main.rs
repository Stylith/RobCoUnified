...
use nucleon::native::{
    ...
    standalone_env_value, NucleonNativeApplicationsApp,
};
...
fn main() -> Result<()> {
    ...
    let mut viewport = ViewportBuilder::default()
        ...
        .with_inner_size(NucleonNativeApplicationsApp::default_window_size())
        .with_min_inner_size(NucleonNativeApplicationsApp::min_window_size());
    ...
    eframe::run_native(
        ...
        Box::new(move |cc| {
            ...
            Ok(Box::new(NucleonNativeApplicationsApp::new(
