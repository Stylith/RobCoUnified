// Desktop background, icons, drag-drop.

use super::app::{
    AssetCache, ContextMenuAction, DesktopIconSelection, RobcoNativeApp, ShortcutPropertiesState,
...
use super::desktop_surface_service::{
    desktop_builtin_icons, finalize_dragged_icon_position, icon_position,
    update_dragged_icon_position, DesktopBuiltinIconKind, DesktopIconDragGrid,
    DesktopIconGridLayout,
};
use super::file_manager::FileManagerCommand;
use super::file_manager_app::{self, FileManagerPromptRequest, NativeFileManagerDragPayload};
use super::retro_ui::{current_palette, RetroPalette};
use crate::config::{
    desktop_dir as robco_desktop_dir, DesktopIconSortMode, DesktopIconStyle, WallpaperSizeMode,
};
use eframe::egui::{self, Align2, Color32, Context, FontFamily, FontId};
