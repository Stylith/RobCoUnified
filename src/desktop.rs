...
use crate::connections::{
    ...
    discovered_row_label, filter_discovered_connections, forget_saved_connection,
    ...
    bluetooth_installer_hint, DiscoveredConnection,
};
use crate::documents;
...
const START_SYSTEM_VIS_ROWS: [Option<usize>; 5] =
    ...
    match hub.kind {
        ...
        DesktopHubKind::Connections => vec![
            DesktopHubItem {
                ...
                action: DesktopHubItemAction::OpenConnectionsKind(ConnectionKind::Network),
                enabled: true,
            },
            DesktopHubItem {
        ...
        DesktopHubKind::ConnectionsNetwork => {
            ...
            let saved = saved_connections(ConnectionKind::Network);
            let mut items = vec![
                DesktopHubItem {
        ...
        DesktopHubKind::ConnectionsBluetooth => {
            ...
            let mut items = vec![
                ...
                DesktopHubItem {
                    label: "Disconnect Active Bluetooth Device".to_string(),
                    action: DesktopHubItemAction::DisconnectConnection {
...
fn run_desktop_hub_action(
    ...
    match action {
        ...
        DesktopHubItemAction::InstallBluetoothRuntime => {
            if !cfg!(target_os = "macos") {
                flash_message(terminal, "blueutil installer is available on macOS only.", 1200)?;
                return Ok(());
            }
